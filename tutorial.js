class Tutorial {
    ...
    async initializeTextures() {
        ...
        console.log(MIPMAP, MIPMAP.numMipLevels([image.width, image.height]));
        this.gpuMapTexture = this.device.createTexture({
            ...
            mipLevelCount: MIPMAP.numMipLevels([image.width, image.height]),
        });
        ...
        MIPMAP.generateMipmap(this.device, this.gpuMapTexture);
